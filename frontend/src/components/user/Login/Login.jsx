    ...
    return (
        <div className='bg-white min-h-screen'>
            <div className="relative flex flex-col justify-center min-h-screen overflow-hidden ">
                    <h1 className='text-5xl text-center mt-48 font-mono text-black'>Razzvie</h1>
                <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl  lg:max-w-xl">
                    ...
                    <form className="mt-6" onSubmit={login}>
                        ...
                        <div className="mt-6">
                            <button type='submit' className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-black rounded-md hover:bg--600 focus:outline-none focus:bg-purple-600" onSubmit={login}>
                                Login
                            </button>
                        </div>
                    </form>
                    ...
                    <p className="mt-8 text-xs font-light text-center text-gray-700">
                        ...
                        <Link to='/otp-phone'>
                        <p className="mt-3 text-xs font-mono text-center text-gray-700">Login with phone</p>
                        </Link>
                    </p>
                </div>
            </div>
